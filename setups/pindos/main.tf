...
module "pindos" {
  ...
  vm_ostemplate           = "Vault:vztmpl/ubuntu-22.04-standard_22.04-1_amd64.tar.zst"
  vm_tags                 = ["ubuntu_22_04_jammy", "docker", "devsys", "portainer"]
  ...
  EOT
  vm_network_ip           = "192.168.55.102/24"
